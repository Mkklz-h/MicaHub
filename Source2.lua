...
function StartLoadingScreen:Init()
    ...
    gui.Name = "EjectingOptionsLoading"
    ...
    local barBG = Instance.new("ImageLabel", mainFrame)
    ...
    barBG.SliceScale = 0.02
    barBG.BackgroundTransparency = 1
    barBG.ImageColor3 = Color3.fromRGB(40, 40, 40)

    local bar = Instance.new("ImageLabel", barBG)
    ...
    bar.SliceScale = 0.02
    bar.ImageColor3 = Color3.fromRGB(255, 65, 65)
