...
local StartLoadingScreen = {}

function StartLoadingScreen:Init()
    local gui = Instance.new("ScreenGui", game:GetService("CoreGui"))
    gui.Name = "EjectingOptionsUI"
    ...
    barBackground.Size = UDim2.new(0.9, 0, 0.18, 0)
    barBackground.Image = "rbxassetid://3570695787"
    barBackground.ScaleType = Enum.ScaleType.Slice
    barBackground.SliceCenter = Rect.new(100, 100, 100, 100)
    barBackground.SliceScale = 0.02
    barBackground.BackgroundTransparency = 1
    barBackground.ImageColor3 = Color3.fromRGB(40, 40, 40)
    ...
    barFill.Image = "rbxassetid://3570695787"
    barFill.ScaleType = Enum.ScaleType.Slice
    barFill.SliceCenter = Rect.new(100, 100, 100, 100)
    barFill.SliceScale = 0.02
    barFill.ImageColor3 = Color3.fromRGB(255, 65, 65)

    local tweenService = game:GetService("TweenService")
    local tween = tweenService:Create(barFill, TweenInfo.new(2, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
